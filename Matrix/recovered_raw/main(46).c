...
/*for int*/
void DLL_EXPORT display_matrix(row2,coloum2,aray)
int row2,coloum2;
...
/*for float*/
void DLL_EXPORT display_dmatrix(row2,coloum2,aray)
int row2,coloum2;
...
/*takes argument*/
void DLL_EXPORT tran_arg(row1,coloum1,arg)
...
/*takes argument*/
void DLL_EXPORT prop_arg(row,coloum,arg)
...
/*arg+point*/
void DLL_EXPORT prop_arg_p(row,coloum,row_p,coloum_p,arg)
...
void DLL_EXPORT dprop_arg(row,coloum,row_p,coloum_p,arg)
...
/*same*/
/*int*/ /*nmatrix*/
void DLL_EXPORT donate_n(row3,coloum3,aray1)
...
/*matrix*/
void DLL_EXPORT donate_m(row3,coloum3,aray1)
int row3,coloum3,aray1[row3][coloum3];
{
    int i,j;
...
/*float*/ /*d_nmatrix*/
void DLL_EXPORT donate_dn(row3,coloum3,aray1)
int row3,coloum3;
...
/*d_matrix*/
void DLL_EXPORT donate_dm(row3,coloum3,aray1)
int row3,coloum3;
float aray1[row3][coloum3];
{
    int i,j;
...
/*user difined aray*/
/*int*/
void DLL_EXPORT donate_arg(row3,coloum3,aray1,aray3)
...
/*float*/
void DLL_EXPORT donate_darg(row3,coloum3,aray1,aray3)
int row3,coloum3;
...
void DLL_EXPORT show_result_a(r)
int r;
{
    int i=0;
    for(i;i<r;i++)
...
/*same*/
/*int*/
void DLL_EXPORT vec_mul(row1,coloum1,row2,coloum2,aray1,aray2)
...
/*float*/
void DLL_EXPORT dvec_mul(row1,coloum1,row2,coloum2,aray1,aray2)
int row1,coloum1,row2,coloum2;
...
/*Extra*/
void DLL_EXPORT copyr(r)
int* r;
{
    *r=row;
}
void DLL_EXPORT copyc(c)
int* c;
{
    *c=coloum;
}
void DLL_EXPORT copy_result(r)
float* r;
{
    *r=result;
}
...
void DLL_EXPORT emp_arg(row4,coloum4,aray4)
...
void DLL_EXPORT make_darg(row,coloum,aray)
...
//This is the data reader.
    int DLL_EXPORT read_char(i,dat)
    int i;
    char dat[i];
    {
        int flag=1,gi;
...
//This is the data writer.
    void DLL_EXPORT display_char(k,dat)
    int k;
    char dat[k];
    {
        int i;
...
void DLL_EXPORT unknown(k,dat,des)
int k;
char dat[k],des[3];
{
    int i,j=0;
 ...
 int DLL_EXPORT floatChecking(pro)
 float pro;
 {
 ...
 void DLL_EXPORT showIresult(c,rf)
 char c;
 float rf;
 {
     int isInt=rf;
 ...
 void DLL_EXPORT showFresult(c,rf)
 char c;
 float rf;
 {
     printf("              %c=%f\n",c,rf);
 }
 void DLL_EXPORT showResult3D(res,result)
 char res[5];
 float result[3][1];
 {
 ...
 void DLL_EXPORT showResult2D(res,result)
 char res[5];
 float result[2];
 {
